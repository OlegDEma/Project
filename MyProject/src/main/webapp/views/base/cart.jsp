...
<div id="wrap">
       ...
       <div class="header">
       		<div class="logo"><a href="home"><img src="images/logo.gif" alt="" title="" border="0" /></a></div>            
        <div id="menu">
            <ul>                                                                       
       ...
       <div class="center_content">
       	<div class="left_content">
            ...
            <table class="cart_table">
            	...
            	<tr>
                	<td><a href="details.html"><img src="${cart.pImage}" alt="" title="" border="0" class="cart_thumb" /></a></td>
                	<td>${cart.name }</td>
            ...
            <a href="#" id="lal" class="continue">&lt; continue</a>
